...
@section('content')
    <div class="row justify-content-center">
        <div class="{{auth()->user() ? 'col-xl-12 col-lg-12': 'col-lg-8 mt-4'}}">
            <div class="dashboard-card-wrap mt-0">
                <div class="row gy-4">
                    <div class="col-md-12">
                        <div class="view-ticket-head">
                            <h5>
                    ...
                    @if ($myTicket->status != 4)
                        <form method="post" action="{{ route('ticket.reply', $myTicket->id) }}"
                            ...
                            <div class="col-sm-12 text-end">
                                <button type="submit" class="btn btn--base btn--sm"> <i class="fa fa-reply"></i>
                                    @lang('Reply')</button>
                            </div>
                        </form>
                    @endif
                                    ...
                                    <div class="support_reply__single mb-3">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                @endif
                                                <h6>{{ $message->created_at->format('l, dS F Y @ H:i') }}</p>
                                                </h6>
                                            </div>
