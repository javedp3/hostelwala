    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="dashboard-card-wrap mt-0" id="dropzone">
                <form action="{{ route('user.hostel.update', $hostel->id) }}" method="POST" enctype ='multipart/form-data'>
                    @csrf
                    @method('put')
                    <div class="row gy-4">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input--group">
                                    <input type="text" id="room_number" name="name" class="form--control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input--group">
                                    <textarea type="text" id="hostel_rules" name="hostel_rules" class="form--control trumEdit1"
                                        placeholder="Hostel Rules"> @php echo (__(@$hostel->hostel_rules)) @endphp</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input--group">
                                    <textarea type="text" id="description" name="description" class="form--control trumEdit2" placeholder="Description">@php echo (__(@$hostel->description)) @endphp</textarea>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="file-upload">
                                            ...
                                            <input type="text" name="facilities[]" id="inputFacilities"
                                                ...
                                                placeholder="Hostel Facilaties" value="{{ $hostel->facilities[0] }}" />
                                        </div>
                                    </div>

                                    <div class="col-sm-6">
                                        <div class="file-upload">
                                            <label class="form-label input-group">@lang('Icons')</label>
                                            <div class="file-upload input-group">
                                                <input type="text" name="icons[]" id="inputIcon"
                                                    class="form-control form--control iconPicker icon"
                                                    placeholder="Hostel Icons" required value="{{ $hostel->icons[0] }}" />
                                        ...
                                        <div class="row elements">
                                            ...
                                            <div class="col-sm-6 mt-3">
                                                <div class="file-upload input-group">
                                                    ...
                                                    iconPicker icon"
                                                        required placeholder="Hostel Icons" value="{{ $icons[$index] }}" />
                                                    <span class="input-group-text input-group-addon" data-icon="las la-home"
                                                        role="iconpicker"></span>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group mb-15">
                                <label for="location"
                                    class="required font-weight-bold">@lang('location')@lang('(city, state, county)')</label>
                                <div class="position-relative location--search-wrap custom-location-admin">
                                    <input type="text" class="form--control" name="location" id="location"
                                        value="{{ $hostel->address }}" onkeyup="startSearchTimeout()" autocomplete="off"
                        ...
                        <input type="hidden" name="country_input" id="country-input" value="{{ $hostel->country }}">
                                    ...
                                    @foreach ($hostel->hostel_images as $i => $img)
                                        <div class='img-div' id='img-div{{ $i }}'
                                            ...
                                            <img src="{{ getImage(getFilePath('hostel') . '/' . $img->path . $img->image) }}"
                                                class='img-responsive image img-thumbnail' title='{{ $img->image }}'>
                                            @if ($i != 0)
                                                <div class='middle'><button id='action-icon'
                                                        value='img-div{{ $i }}' class='delete-btn btn-danger'
                                                        role='{{ $img->image }}'><i class='fa fa-trash'></i></button>
                                                </div>
                                            @endif
                                        </div>
                                    @endforeach
...
@push('script')
    ...
    <script>
        function imageDelete(object, $id) {
            var url = "{{ route('user.hostel.image.delete') }}";
