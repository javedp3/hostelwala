...
@section('content')
                            ...
                            <form action="{{route('user.register')}}" method="POST" class="verify-gcaptcha">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="mobile" class="form--label required">@lang('Mobile Number')</label>
                                            <div class="input--group">
                                                <span class="input-group-text mobile-code"></span>
                                                <input type="hidden" name="mobile_code">
                                                <input type="hidden" name="country_code">
                                                <input type="number" class="form--control checkUser left-padding" name="mobile" id="mobile" value="{{ old('mobile') }}" placeholder="Mobile number" required="">
                                                <div class="input--icon">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form--check">
                                                <input class="form-check-input" type="checkbox"
                                                    id="agree" @checked(old('agree')) name="agree" required>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="have-account text-center">
                                            <p class="mb-0">@lang('Already have an account?') <a
                                                    href="{{ route('user.login') }}" class="text--base">@lang('Login')</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="existModalCenter" tabindex="-1" role="dialog" aria-labelledby="existModalCenter"
        aria-hidden="true">
