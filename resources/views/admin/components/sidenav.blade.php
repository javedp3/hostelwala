    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar__menu-header">@lang('Hostel & Room Management')</li>
                <li class="sidebar-menu-item {{ menuActive('admin.hostel.list') }}">
                    <a href="{{ route('admin.hostel.list') }}" class="nav-link ">
                        <i class="menu-icon las la-home"></i>
                        <span class="menu-title">@lang('Hostels')</span>
                    </a>
                </li>

                <li class="sidebar__menu-header">@lang('Bookings Management')</li>
                <li class="sidebar-menu-item {{ menuActive('admin.booking.list') }}">
                ...
                <li class="sidebar__menu-header">@lang('Community Post Management')</li>
                <li class="sidebar-menu-item {{ menuActive('admin.community.list') }}">
                    <a href="{{ route('admin.community.list') }}" class="nav-link ">
                        <i class="menu-icon las la-share-alt"></i>
                        <span class="menu-title">@lang('Communities Post')</span>
                    </a>
                </li>
                <li class="sidebar__menu-header">@lang('Coupon')</li>
                <li class="sidebar-menu-item {{ menuActive('admin.coupon.list') }}">
                ...
                <li class="sidebar__menu-header">@lang('KYC')</li>
