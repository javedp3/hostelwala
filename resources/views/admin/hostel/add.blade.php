                            ...
                            <div class="row gy-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="name" name="name" class="form-control"
                                                placeholder="Hostel Title" value="{{ old('name') }}" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input--group">
                                            <textarea type="text" id="hostel_rules" name="hostel_rules" class="form-control trumEdit1"
                                                placeholder="@lang('Hostel Rules')">{{ old('hostel_rules') }}</textarea>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input--group">
                                            <textarea type="text" id="description" name="description" class="form-control trumEdit2" placeholder="Description">{{ old('description') }}</textarea>
