                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-9 col-xs-12">
                                        <select class="form-control" name="site_banner">
                                            <option value="1" {{$general->site_banner === 1 ? 'selected':''}}>@lang('Home 1')</option>
                                            <option value="2" {{$general->site_banner === 2 ? 'selected':''}}>@lang('Home 2')</option>
                                        </select>
                                    </div>
                                </div>
