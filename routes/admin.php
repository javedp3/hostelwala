...
Route::middleware('admin')->group(function () {
    ...
    // Room
    Route::controller('ManageRoomController')->name('room.')->group(function () {
        Route::get('room-list/{hostel_id}', 'room_list')->name('list');
        Route::get('add-room/{hostel_id}', 'add_room')->name('add');
        Route::post('store/{hostel_id}', 'store')->name('store');
        Route::get('room-edit/{hostel_id}/{room_id}', 'edit')->name('edit');
        Route::put('room-update/{hostel_id}/{room_id}', 'update')->name('update');
        Route::get('room-delete/{hostel_id}/{room_id}', 'delete')->name('delete');
        Route::post('room-status', 'roomStatus')->name('status');
        Route::get('room-active/{hostel_id}', 'active')->name('active');
        Route::get('room-pending/{hostel_id}', 'pending')->name('pending');
    });


    // Hostel
    Route::controller('ManageHostelController')->prefix('hostel')->name('hostel.')->group(function () {
        Route::get('hostel-list', 'hostel_list')->name('list');
        Route::get('my-hostel-list', 'my_hostel_list')->name('my.list');
        ...
        Route::post('hostel-status', 'hostelStatus')->name('status');
        Route::post('image-delete', 'hostelImageDelete')->name("image.delete");
        Route::get('active', 'active')->name('active');
        Route::get('pending', 'pending')->name('pending');
        Route::get('details/{hostel}', 'details')->name('details');
        Route::get('/{hostel}', 'details')->name('details');
        Route::get('hostel_view/{hostel}', 'hostel_view')->name('view');
    });

    // Coupon
    Route::controller('CouponController')->name('coupon.')->group(function () {
        Route::get('coupon-list', 'coupon_list')->name('list');
        Route::post('coupon-store', 'store')->name('store');
        Route::post('coupon-status', 'couponStatus')->name('status');
    });
    ...
    Route::controller('CommunityController')->name('community.')->group(function () {
        Route::get('community-list', 'community_list')->name('list');
        Route::post('community-status', 'communityStatus')->name('status');
    });
